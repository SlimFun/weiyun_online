...
class DQNPrioritizedReplay:
    ...
    def learn(self):
        ...
        if self.prioritized:
            tree_idx, batch_memory, ISWeights = self.env.memory.sample(self.batch_size)
        else:
        ...
        if self.prioritized:
            ...
            self.env.memory.batch_update(tree_idx, abs_errors)     # update priority
        else:
    ...
    def store_model(self):
        self.saver.save(self.sess, 'my_prio_net/save_net.ckpt')
        logger.info('store model to my_prio_net/save_net.ckpt')
